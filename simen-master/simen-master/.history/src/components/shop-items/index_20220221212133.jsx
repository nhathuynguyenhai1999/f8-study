      ...
      <Row className={styles.container}>
        {items.map((item) => (
          <>
            ...
            <Col span={4} className={styles.quantity} onClick={() => setItem(item)}>
              <div className={styles['quantity-button']} onClick={removeFromCartHandler}>
                -
              </div>
              <p>{item.quantity}</p>
              <div className={styles['quantity-button']} onClick={addToCartHandler}>
                +
              </div>
            </Col>
