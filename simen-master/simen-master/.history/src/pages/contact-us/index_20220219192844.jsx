        ...
        <div className={styles.input}>
          ...
          <div className={styles['input-box']}>
            <div className={styles['input-group']}>
              <Input className={styles['input-small']} placeholder="Name" />
              <Input className={styles['input-small']} placeholder="Email" />
              <Input className={styles['input-small']} placeholder="Telephone" />
            </div>
            <div className={styles['input-group']}>
              <Input className={styles['input-large']} placeholder="Comment" />

              <CustomButton text={'Send Email'} className={styles.button} />
            </div>
          </div>
        </div>
      </div>
