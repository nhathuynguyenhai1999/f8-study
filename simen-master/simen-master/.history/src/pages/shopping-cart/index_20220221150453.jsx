    ...
    <div>
      ...
      <div className={styles.table}>
        ...
        <div className={styles.container}>
          ...
          <div className={styles.quantity}><input type="number" id="quantity_62133239937a7" class="input-text qty text" step="1" min="0" max="" name="cart[283085d30e10513624c8cece7993f4de][qty]" value="1" title="Qty" size="4" inputmode="numeric"></div>
        </div>
        <div className={styles.container}>
