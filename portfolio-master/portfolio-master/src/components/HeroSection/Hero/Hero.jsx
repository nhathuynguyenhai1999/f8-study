...
function Hero() {
  return (
    <div className="md:flex md:justify-between md:items-center md:mt-4">
      <div className="text-48 md:text-[56px] text-tx-primary font-bold md:flex-[50%] md:flex">
        <h1>Hey There,</h1>
        <span className="hidden md:block w-3"> </span>
        <h1>I'm Chính</h1>
      </div>
      ...
      <div className="md:block hidden">
        <div
          ...
          className="w-[80%] h-[75%] mx-auto box-border shadow-inner bg-no-repeat bg-cover absolute left-[50%] translate-x-[-50%] bottom-0 bg-center"
        ></div>
      </div>
    </div>
  );
