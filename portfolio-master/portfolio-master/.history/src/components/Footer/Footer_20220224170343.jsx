...
function Footer() {
  return (
    <div
      id="contact"
      className="bg-primary py-[35px] px-6 md:grid md:grid-cols-[5fr 1fr] md:px-[100px]"
    >
      <div>
        <h1 className="title text-24 mb-5">Some Contact Information.</h1>
        ...
        <p className="hidden md:block title text-24 mt-10">
          Start by{' '}
          <a
      ...
      <ul className="text-black text-20 flex gap-4 ml-4 mb-6 md:flex-col">
