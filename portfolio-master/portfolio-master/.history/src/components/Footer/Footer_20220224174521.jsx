...
function Footer() {
  return (
    <div
      id="contact"
      className="bg-primary py-[35px] px-6 md:grid md:grid-cols-10 md:px-[100px]"
    >
      ...
      <ul className="text-black text-20 flex gap-4 ml-4 mb-6 md:flex-col md:gap-8 md:flex-[50%]">
