  ...
  return (
    <div className="p-[25px] bg-primary">
      <div className="flex gap-5 mb-4">
        ...
        <div>
          <h1 className="text-tx-primary text-[28px] font-semibold mb-4">
            Da Nang University of Economics
          </h1>
          <p className="paragraph mb-5">
            Team-worked in a lot of projects for 4 years, with skills such as
            presentation, planning, requirement analyzing, reporting, time
            allocation
          </p>
          <h3 className="mb-2 text-tx-primary text-20 font-semibold">
            Bachelor of Business Administration (2017 - 2022)
          </h3>
          <p className="paragraph">2017 - 2022</p>
        </div>
      </div>
