  ...
  return (
    <div className="p-[25px] bg-primary">
      <div className="flex gap-5">
        <div className="mt-1">
          <div className="relative flex items-center justify-center w-[40px] h-[40px] border border-black border-dashed rounded-full">
            <div className="w-[50%] h-[50%] bg-green rounded-full"></div>
            <div className="absolute h-full border border-black border-dashed rounded-full"></div>
          </div>
        </div>
        <div>
