...
function Hero() {
  return (
    <div className="md:flex md:justify-between md:items-center">
      ...
      <div className="paragraph text-[15px] mb-4 md:mb-0 md:flex md:flex-col md:justify-center md:flex-[50%]">
        <p className="pb-[4px]">
      ...
      <div className="">
        <div
          ...
          className="w-[100%] h-[50%] box-border shadow-inner bg-no-repeat bg-cover absolute left-0 bottom-0 bg-center"
        ></div>
      </div>
    </div>
  );
