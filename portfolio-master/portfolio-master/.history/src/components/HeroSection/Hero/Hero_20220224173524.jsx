...
function Hero() {
  return (
    <div className="md:flex md:justify-between md:items-center">
      <div className="text-48 md:text-[60px] text-tx-primary font-bold md:flex-[50%]">
        <h1>Hey There,</h1>
        <h1>I'm Chính</h1>
      </div>
      ...
      <div className="md:hidden">
        <div
          ...
          className="w-[100%] h-[48%] mx-auto box-border shadow-inner bg-no-repeat bg-cover absolute left-0 bottom-0 bg-center"
        ></div>
      </div>
      <div className="md:block hidden">
        <div
          ...
          className="w-[80%] h-[80%] mx-auto box-border shadow-inner bg-no-repeat bg-contain absolute left-[50%] translate-x-[-50%] bottom-0 bg-center"
        ></div>
      </div>
    </div>
  );
