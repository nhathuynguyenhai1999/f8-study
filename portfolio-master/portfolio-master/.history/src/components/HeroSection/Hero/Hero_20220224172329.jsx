...
function Hero() {
  return (
    <div className="md:flex md:justify-between md:items-center">
      ...
      <div className="md:h-[80%] md:absolute md:w-full md:h-full">
        <div
          style={{
            backgroundImage: `url('${Ava}')`,
          }}
          className="w-[100%] h-[50%] md:w-[80%] md:h-full mx-auto box-border shadow-inner bg-no-repeat bg-cover absolute left-0 bottom-0 bg-center"
        ></div>
      </div>
    </div>
  );
