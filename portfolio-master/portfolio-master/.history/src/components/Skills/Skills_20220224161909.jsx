        ...
        {items.map((item) => (
          <div className="p-5 border rounded-xl border-gray-400 relative">
            <div
              ...
              className="absolute md:w-[60px] md:h-[60px] md:text-20 w-[40px] h-[40px] rounded-full top-[50%] translate-y-[-50%] flex justify-center items-center"
            >
              <AiTwotoneStar size="16px" color="#fff" className="" />
            </div>
