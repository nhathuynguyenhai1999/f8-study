  ...
  return (
    <div className="pt-[50px] px-7 pb-[40px] bg-white">
      ...
      <div className="flex flex-col gap-3 relative">
        {items.map((item) => (
          <div className="flex gap-4 items-center p-5 border rounded-xl border-gray-400">
            <div className="absolute bg-green w-[60px] h-[60px] rounded-full flex justify-center items-center">
