...
function Skills() {
  return (
    <div className="pt-[50px] px-7 pb-[40px] bg-white">
      ...
      <div className="flex flex-col gap-3 relative item-center">
        {items.map((item) => (
          <div className="p-5 border rounded-xl border-gray-400">
            <div
              style={{ backgroundColor: `${item.color}` }}
              className="absolute w-[40px] h-[40px] rounded-full flex justify-center items-center"
            >
              <AiTwotoneStar size="12px" color="#fff" />
            </div>
