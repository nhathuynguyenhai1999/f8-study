...
function Projects() {
  return (
    <div className="pt-[50px] px-6 pb-[200px] relative">
      <h1 className="title">My Project</h1>
      <p className="paragraph">Perfect solution for digital experience</p>
      <div className="flex overflow-auto absolute top-[100%] left-0 w-[100%]">
        <div className="flex items-center justify-center ">
          {projects.map((project) => (
            <div className="w-[70vw] h-full relative pr-2 mt-20">
              <a href={project.link}>
                <img
                  src={project.img}
                  alt=""
