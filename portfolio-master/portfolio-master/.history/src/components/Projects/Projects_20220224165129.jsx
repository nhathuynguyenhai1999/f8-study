...
function Projects() {
  return (
    <div
      id="projects"
      className="pt-[50px] px-6 pb-[330px] md:pt-[20px] md:pb-[600px] relative overflow-hidden"
    >
      ...
      <div className="flex overflow-x-auto no-scrollbar absolute top-[30%] left-[5%] w-[100%]">
        <div className="flex items-center justify-center gap-4">
          {projects.map((project) => (
            <div className="md:w-[420px] md:h-[420px] w-[70vw] h-[210px] relative mt-20 ">
              <a href={project.link}>
                <img
                  src={project.img}
                  alt=""
              ...
              <div className="absolute md:top-[-15%] top-[-25%] left-1 text-green z-10 pr-2">
