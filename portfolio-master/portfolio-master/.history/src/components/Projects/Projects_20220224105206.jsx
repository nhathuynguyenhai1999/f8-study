...
function Projects() {
  return (
    <div className="pt-[50px] px-6 pb-[40px] relative">
      <h1 className="title">My Project</h1>
      <p className="paragraph">Perfect solution for digital experience</p>
      <div className="snap-x snap-align-none flex flex-flow:row h-full w-full  absolute">
        {projects.map((project) => (
          <div className="w-[280px] h-full relative pr-2 mt-20">
            <a href={project.link}>
              <img
                src={project.img}
                alt=""
